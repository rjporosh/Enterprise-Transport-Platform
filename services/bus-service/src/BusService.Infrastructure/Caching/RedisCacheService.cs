...
/// <summary>Cache-aside over Redis. Fails open — a Redis outage degrades to "always hit the database" rather than taking the API down. Same pattern as Auth/Booking Service.</summary>
